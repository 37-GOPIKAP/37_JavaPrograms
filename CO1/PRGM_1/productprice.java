...
System.out.println("MI laptop worth :"  +p1.price);
System.out.println("Redmi 9i worth : "  +p2.price);
System.out.println("SmartBand worth :" +p3.price);
pnname=p3.lowcost(p1,p2);
System.out.println("Lowest price is  for " +pnname + "worth " +p3.price);
